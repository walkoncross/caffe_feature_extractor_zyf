...
if __name__ == '__main__':
    root_dir = r'C:\zyf\dnn_models\face_models\face-datasets-merge\avg_fc5_to_fc6_wts_corr_msceleb'
...
# #    only_after_bin_val = 0.5
    ...
    save_root_dir = './rlt_hist_avg_fc5_to_fc6_wts_corr/feat_hist_on_msceleb'

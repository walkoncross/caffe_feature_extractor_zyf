...
if __name__ == '__main__':
    ...
    prob_dir = '/home/msceleb_probs_on_sphere64_msceleb/corr_prob'
    ...
    save_dir = '../prob-results/msceleb_probs_on_sphere64_msceleb/rlt_top_%d_corr_prob_per_id_img_list' % top_n

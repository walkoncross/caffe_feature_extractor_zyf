...
if __name__ == '__main__':
    ...
    prob_threshs = np.arange(0.615, 0.7, 0.75, 0.8)
    first_new_id = 0
    max_orig_label = 78770

    # image path: osp.join(image_dir, <each line in image_list_file>)
    prob_dir = r'/home/msceleb_probs_on_sphere64_msceleb/prob'
    ...
    # save_dir = None
    save_dir = '../../prob-results/msceleb_probs_on_sphere64_msceleb/softmax_prob_threshed_results'

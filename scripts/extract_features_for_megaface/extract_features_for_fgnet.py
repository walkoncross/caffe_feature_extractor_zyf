...
if __name__ == '__main__':
    ...
    image_list_file = r'/workspace/code/mtcnn-caffe-zyf/scripts/face_aligner/fgnet_mtcnn_aligned/fgnet-mtcnn-aligned-image-list.txt.txt'

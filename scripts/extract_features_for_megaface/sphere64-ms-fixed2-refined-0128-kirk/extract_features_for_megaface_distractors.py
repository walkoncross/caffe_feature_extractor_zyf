...
if __name__ == '__main__':
    ...
    save_dir = '/disk2/zhaoyafei/megaface-eval/features/sphereface-64-ms-fixed2-refined-0128/MegaFace_SPF512Features'
    gpu_id = None
    ...
    image_list_file = r'/disk2/data/FACE/megaface/MegaFace_dataset/megaface-image-list-all.txt'
